...
class Personaje(pygame.sprite.Sprite):
    def __init__(self, nombre, objeto_spritesheets, coordenadas, velocidad, escenario_actual, limites_rectangulo):
        self.nombre = nombre
        ...
        self.limites_rectangulo = limites_rectangulo
    ...
    def update(self, ventana_juego):
        ...
        if eventos[pygame.K_LEFT]:
            ...
            self.rect.move_ip(-self.velocidad_movimiento, 0)
        ...
        #mover el personaje hacia arriba
            ...
            self.ejecutar_animacion = True
            self.rect.move_ip(0, -self.velocidad_movimiento)
